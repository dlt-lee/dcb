dcb.xgb.clu.9<-function(trains,d_o) {
  ...
  if (threads <= 8) {
    bst.a1<-xgboost(data = trains.T[,c(1,08,15,22,29,36,43,50,57)],label = trains$res.a1,nrounds = 300,print_every_n = 300L,params = list(tree_method = 'hist'))
    bst.a2<-xgboost(data = trains.T[,c(2,09,16,23,30,37,44,51,58)],label = trains$res.a2,nrounds = 300,print_every_n = 300L,params = list(tree_method = 'hist'))
    ...
    bst.b1<-xgboost(data = trains.T[,c(7,14,21,28,35,42,49,56,63)],label = trains$res.b1,nrounds = 300,print_every_n = 300L,params = list(tree_method = 'hist'))
    
  }else{
    bst.a1<-xgboost(data = trains.T[,c(1,08,15,22,29,36,43,50,57)],label = trains$res.a1,nrounds = 300,print_every_n = 300L,params = list(tree_method = 'hist',nthread=number_of_core))
    bst.a2<-xgboost(data = trains.T[,c(2,09,16,23,30,37,44,51,58)],label = trains$res.a2,nrounds = 300,print_every_n = 300L,params = list(tree_method = 'hist',nthread=number_of_core))
    ...
    bst.a6<-xgboost(data = trains.T[,c(6,13,20,27,34,41,48,55,62)],label = trains$res.a6,nrounds = 300,print_every_n = 300L,params = list(tree_method = 'hist',nthread=number_of_core))
    bst.b1<-xgboost(data = trains.T[,c(7,14,21,28,35,42,49,56,63)],label = trains$res.b1,nrounds = 300,print_every_n = 300L,params = list(tree_method = 'hist',nthread=number_of_core))
