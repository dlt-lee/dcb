dcb.xgb.clu.9<-function(trains,d_o) {
  ...
  bst.a1<-xgboost(data = trains.T[,c(1,08,15,22,29,36,43,50,57)],label = trains$res.a1,nrounds = 300,print_every_n = 300L,params = list(tree_method = 'gpu_hist'))
  bst.a2<-xgboost(data = trains.T[,c(2,09,16,23,30,37,44,51,58)],label = trains$res.a2,nrounds = 300,print_every_n = 300L,params = list(tree_method = 'gpu_hist'))
