dcb_JL_L7<-function(num,number_of_core) {
  # source("element.R")
  library(xgboost)
  ...
  # print(c('LJ_L7:',sum_JL_dcb))
  write.table(t(as.matrix(sum_JL_dcb,nrow(1))),file = "dcb_data_JL_L7.csv",append = TRUE,col.names = FALSE,row.names = FALSE,quote=TRUE, sep=",")

  # return(sum_JL_dcb)
  return(c('LJ_L7:',sum_JL_dcb))
}
