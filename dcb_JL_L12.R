dcb_JL_L12<-function(num,number_of_core) {
  # source("element.R")
  library(xgboost)
  ...
  write.table(t(as.matrix(sum_JL_dcb,nrow(1))),file = "dcb_data_JL_L12.csv",append = TRUE,col.names = FALSE,row.names = FALSE,quote=TRUE, sep=",")
