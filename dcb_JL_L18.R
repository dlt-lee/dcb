dcb_JL_L18<-function(num,number_of_core) {
  # source("element.R")
  library(xgboost)
  ...
  m_record_a1<-cbind(m_record_l3[,1],m_record_l4[,1],m_record_l5[,1],m_record_l6[,1],m_record_l7[,1],m_record_l8[,1],m_record_l9[,1],m_record_l10[,1],
                     ...
                     m_record_JL_L11[,1],m_record_JL_L12[,1],m_record_JL_L13[,1],m_record_JL_L14[,1],m_record_JL_L15[,1],m_record_JL_L16[,1],m_record_JL_L17[,1])
  ...
  m_record_a2<-cbind(m_record_l3[,2],m_record_l4[,2],m_record_l5[,2],m_record_l6[,2],m_record_l7[,2],m_record_l8[,2],m_record_l9[,2],m_record_l10[,2],
                     m_record_l11[,2],m_record_l12[,2],m_record_l13[,2],m_record_l14[,2],m_record_l15[,2],m_record_l16[,2],m_record_l17[,2],m_record_l18[,2],
                     m_record_JL_L4[,2],m_record_JL_L5[,2],m_record_JL_L6[,2],m_record_JL_L7[,2],m_record_JL_L8[,2],m_record_JL_L9[,2],m_record_JL_L10[,2],
                     m_record_JL_L11[,2],m_record_JL_L12[,2],m_record_JL_L13[,2],m_record_JL_L14[,2],m_record_JL_L15[,2],m_record_JL_L16[,2],m_record_JL_L17[,2])
  ...
  m_record_a3<-cbind(m_record_l3[,3],m_record_l4[,3],m_record_l5[,3],m_record_l6[,3],m_record_l7[,3],m_record_l8[,3],m_record_l9[,3],m_record_l10[,3],
                     m_record_l11[,3],m_record_l12[,3],m_record_l13[,3],m_record_l14[,3],m_record_l15[,3],m_record_l16[,3],m_record_l17[,3],m_record_l18[,3],
                     m_record_JL_L4[,3],m_record_JL_L5[,3],m_record_JL_L6[,3],m_record_JL_L7[,3],m_record_JL_L8[,3],m_record_JL_L9[,3],m_record_JL_L10[,3],
                     m_record_JL_L11[,3],m_record_JL_L12[,3],m_record_JL_L13[,3],m_record_JL_L14[,3],m_record_JL_L15[,3],m_record_JL_L16[,3],m_record_JL_L17[,3])
  ...
  m_record_a4<-cbind(m_record_l3[,4],m_record_l4[,4],m_record_l5[,4],m_record_l6[,4],m_record_l7[,4],m_record_l8[,4],m_record_l9[,4],m_record_l10[,4],
                     m_record_l11[,4],m_record_l12[,4],m_record_l13[,4],m_record_l14[,4],m_record_l15[,4],m_record_l16[,4],m_record_l17[,4],m_record_l18[,4],
                     m_record_JL_L4[,4],m_record_JL_L5[,4],m_record_JL_L6[,4],m_record_JL_L7[,4],m_record_JL_L8[,4],m_record_JL_L9[,4],m_record_JL_L10[,4],
                     m_record_JL_L11[,4],m_record_JL_L12[,4],m_record_JL_L13[,4],m_record_JL_L14[,4],m_record_JL_L15[,4],m_record_JL_L16[,4],m_record_JL_L17[,4])
  
  m_record_a5<-cbind(m_record_l3[,5],m_record_l4[,5],m_record_l5[,5],m_record_l6[,5],m_record_l7[,5],m_record_l8[,5],m_record_l9[,5],
                     m_record_l10[,5],m_record_l11[,5],m_record_l12[,5],m_record_l13[,5],m_record_l14[,5],m_record_l15[,5],m_record_l16[,5],m_record_l17[,5],m_record_l18[,5],
                     m_record_JL_L4[,5],m_record_JL_L5[,5],m_record_JL_L6[,5],m_record_JL_L7[,5],m_record_JL_L8[,5],m_record_JL_L9[,5],m_record_JL_L10[,5],
                     m_record_JL_L11[,5],m_record_JL_L12[,5],m_record_JL_L13[,5],m_record_JL_L14[,5],m_record_JL_L15[,5],m_record_JL_L16[,5],m_record_JL_L17[,5])
  ...
  m_record_a6<-cbind(m_record_l3[,6],m_record_l4[,6],m_record_l5[,6],m_record_l6[,6],m_record_l7[,6],m_record_l8[,6],m_record_l9[,6],m_record_l10[,6],
                     m_record_l11[,6],m_record_l12[,6],m_record_l13[,6],m_record_l14[,6],m_record_l15[,6],m_record_l16[,6],m_record_l17[,6],m_record_l18[,6],
                     m_record_JL_L4[,6],m_record_JL_L5[,6],m_record_JL_L6[,6],m_record_JL_L7[,6],m_record_JL_L8[,6],m_record_JL_L9[,6],m_record_JL_L10[,6],
                     m_record_JL_L11[,6],m_record_JL_L12[,6],m_record_JL_L13[,6],m_record_JL_L14[,6],m_record_JL_L15[,6],m_record_JL_L16[,6],m_record_JL_L17[,6])
  ...
  m_record_b1<-cbind(m_record_l3[,7],m_record_l4[,7],m_record_l5[,7],m_record_l6[,7],m_record_l7[,7],m_record_l8[,7],m_record_l9[,7], m_record_l10[,7],
                     m_record_l11[,7],m_record_l12[,7],m_record_l13[,7],m_record_l14[,7],m_record_l15[,7],m_record_l16[,7],m_record_l17[,7],m_record_l18[,7],
                     m_record_JL_L4[,7],m_record_JL_L5[,7],m_record_JL_L6[,7],m_record_JL_L7[,7],m_record_JL_L8[,7],m_record_JL_L9[,7],m_record_JL_L10[,7],
                     m_record_JL_L11[,1],m_record_JL_L12[,7],m_record_JL_L13[,7],m_record_JL_L14[,7],m_record_JL_L15[,7],m_record_JL_L16[,7],m_record_JL_L17[,7])
  ...
  write.table(t(as.matrix(sum_JL_dcb,nrow(1))),file = "dcb_data_JL_L18.csv",append = TRUE,col.names = FALSE,row.names = FALSE,quote=TRUE, sep=",")
