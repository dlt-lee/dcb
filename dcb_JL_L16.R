dcb_JL_L16<-function(num,number_of_core) {
  ...
  write.table(t(as.matrix(sum_JL_dcb,nrow(1))),file = "dcb_data_JL_L16.csv",append = TRUE,col.names = FALSE,row.names = FALSE,quote=TRUE, sep=",")
  
  # return(sum_JL_dcb)
  return(c('LJ_L16:',sum_JL_dcb))
}
