dcb_JL_L11<-function(num,number_of_core) {
  # source("element.R")
  library(xgboost)
  ...
  m_record_b1<-cbind(m_record_l3[,7],m_record_l4[,7],m_record_l5[,7],m_record_l6[,7],m_record_l7[,1],m_record_l8[,7],m_record_l9[,7],m_record_l10[,7],
                     m_record_l11[,7],
  ...
  # print(c('LJ_L11:',sum_JL_dcb))
  write.table(t(as.matrix(sum_JL_dcb,nrow(1))),file = "dcb_data_JL_L11.csv",append = TRUE,col.names = FALSE,row.names = FALSE,quote=TRUE, sep=",")
  
  # return(sum_JL_dcb)
  return(c('LJ_L11:',sum_JL_dcb))
}
