dcb.xgb.clu.2<-function(trains,d_o) {
  ...
  bst.a6<-xgboost(data = trains.T[,c(55,62)],label = trains$res.a6,nrounds = 300,print_every_n = 300L)
  bst.b1<-xgboost(data = trains.T[,c(56,63)],label = trains$res.b1,nrounds = 300,print_every_n = 300L)
