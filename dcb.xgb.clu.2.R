dcb.xgb.clu.2<-function(trains,d_o) {
  ...
  if (threads <= 8) {
    ...
    bst.a6<-xgboost(data = trains.T[,c(55,62)],label = trains$res.a6,nrounds = 300,print_every_n = 300L,params = list(tree_method = 'hist'))
    bst.b1<-xgboost(data = trains.T[,c(56,63)],label = trains$res.b1,nrounds = 300,print_every_n = 300L,params = list(tree_method = 'hist'))
    ...
    bst.a6<-xgboost(data = trains.T[,c(55,62)],label = trains$res.a6,nrounds = 300,print_every_n = 300L,params = list(tree_method = 'hist',nthread=number_of_core))
    bst.b1<-xgboost(data = trains.T[,c(56,63)],label = trains$res.b1,nrounds = 300,print_every_n = 300L,params = list(tree_method = 'hist',nthread=number_of_core))
  ...
  testPredictions.a6 <- predict(object = bst.a6,newdata = tests.T[,c(55,62)])
  testPredictions.b1 <- predict(object = bst.b1,newdata = tests.T[,c(56,63)])
