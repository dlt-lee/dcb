...
L2_1<-dlt_sum_cum(dcb,unit*1)
L2_2<-dlt_sum_cum(dcb,unit*2)
L2_3<-dlt_sum_cum(dcb,unit*3)
L2_4<-dlt_sum_cum(dcb,unit*4)
L2_5<-dlt_sum_cum(dcb,unit*5)


sum_l2_ab<-dlt_sum_L2(dcb)
