dcb_JL_L13<-function(num,number_of_core) {
  ...
  m_record_a1<-cbind(m_record_l3[,1],m_record_l4[,1],m_record_l5[,1],m_record_l6[,1],m_record_l7[,1],m_record_l7[,1],m_record_l8[,1],m_record_l9[,1],m_record_l10[,1],m_record_l11[,1],m_record_l12[,1],m_record_l13[,1],
                     m_record_JL_L4[,1],m_record_JL_L5[,1],m_record_JL_L6[,1],m_record_JL_L6[,1],m_record_JL_L7[,1],m_record_JL_L8[,1],m_record_JL_L9[,1],m_record_JL_L10[,1],m_record_JL_L11[,1],m_record_JL_L12[,1])
  m_record_a2<-cbind(m_record_l3[,2],m_record_l4[,2],m_record_l5[,2],m_record_l6[,2],m_record_l7[,2],m_record_l7[,1],m_record_l8[,2],m_record_l9[,2],m_record_l10[,2],m_record_l11[,2],m_record_l12[,2],m_record_l13[,2],
                     m_record_JL_L4[,2],m_record_JL_L5[,2],m_record_JL_L6[,2],m_record_JL_L6[,1],m_record_JL_L7[,2],m_record_JL_L8[,2],m_record_JL_L9[,2],m_record_JL_L10[,2],m_record_JL_L11[,1],m_record_JL_L12[,2])
  m_record_a3<-cbind(m_record_l3[,3],m_record_l4[,3],m_record_l5[,3],m_record_l6[,3],m_record_l7[,3],m_record_l7[,1],m_record_l8[,3],m_record_l9[,3],m_record_l10[,3],m_record_l11[,3],m_record_l12[,3],m_record_l13[,3],
                     m_record_JL_L4[.3],m_record_JL_L5[,3],m_record_JL_L6[,3],m_record_JL_L6[,1],m_record_JL_L7[,3],m_record_JL_L8[,3],m_record_JL_L9[,3],m_record_JL_L10[,3],m_record_JL_L11[,1],m_record_JL_L12[,3])
  m_record_a4<-cbind(m_record_l3[,4],m_record_l4[,4],m_record_l5[,4],m_record_l6[,4],m_record_l7[,4],m_record_l7[,1],m_record_l8[,4],m_record_l9[,4],m_record_l10[,4],m_record_l11[,4],m_record_l12[,4],m_record_l13[,4],
                     m_record_JL_L4[,4],m_record_JL_L5[,4],m_record_JL_L6[,4],m_record_JL_L6[,1],m_record_JL_L7[,4],m_record_JL_L8[,4],m_record_JL_L9[,4],m_record_JL_L10[,4],m_record_JL_L11[,1],m_record_JL_L12[,4])
  m_record_a5<-cbind(m_record_l3[,5],m_record_l4[,5],m_record_l5[,5],m_record_l6[,5],m_record_l7[,5],m_record_l7[,1],m_record_l8[,5],m_record_l9[,5],m_record_l10[,5],m_record_l11[,5],m_record_l12[,5],m_record_l13[,5],
                     m_record_JL_L4[,5],m_record_JL_L5[,5],m_record_JL_L6[,5],m_record_JL_L6[,1],m_record_JL_L7[,5],m_record_JL_L8[,5],m_record_JL_L9[,5],m_record_JL_L10[,5],m_record_JL_L11[,1],m_record_JL_L12[,5])
  m_record_a6<-cbind(m_record_l3[,6],m_record_l4[,6],m_record_l5[,6],m_record_l6[,6],m_record_l7[,6],m_record_l7[,1],m_record_l8[,6],m_record_l9[,6],m_record_l10[,6],m_record_l11[,6],m_record_l12[,6],m_record_l13[,6],
                     m_record_JL_L4[,6],m_record_JL_L5[,6],m_record_JL_L6[,6],m_record_JL_L6[,1],m_record_JL_L7[,6],m_record_JL_L8[,6],m_record_JL_L9[,6],m_record_JL_L10[,6],m_record_JL_L11[,1],m_record_JL_L12[,6])
  m_record_b1<-cbind(m_record_l3[,7],m_record_l4[,7],m_record_l5[,7],m_record_l6[,7],m_record_l7[,7],m_record_l7[,1],m_record_l8[,7],m_record_l9[,7],m_record_l10[,7],m_record_l11[,7],m_record_l12[,7],m_record_l13[,7],
                     m_record_JL_L4[,7],m_record_JL_L5[,7],m_record_JL_L6[,7],m_record_JL_L6[,1],m_record_JL_L7[,7],m_record_JL_L8[,7],m_record_JL_L9[,7],m_record_JL_L10[,7],m_record_JL_L11[,1],m_record_JL_L12[,7])
  ...
  m_record_JL<-as.data.frame(read.csv(file = "dcb_data_JL_L13.csv", header = FALSE))[-1,]
  m_r_ab_delta<-rbind(m_record_JL,sum_JL_dcb)
  write.csv(m_r_ab_delta, file = "dcb_data_JL_L13.csv",row.names = FALSE)
}
