dcb_JL<-function(num,number_of_core) {
  ...
  m_record_a1<-cbind(m_record_l3[,1],m_record_l4[,1],m_record_l5[,1],m_record_l6[,1],m_record_l7[,1],m_record_l8[,1],m_record_l9[,1],m_record_l10[,1],m_record_l11[,1],m_record_l12[,1],m_record_l13[,1],m_record_l14[,1],m_record_l15[,1],m_record_l16[,1],m_record_l17[,1],m_record_l18[,1])
  m_record_a2<-cbind(m_record_l3[,2],m_record_l4[,2],m_record_l5[,2],m_record_l6[,2],m_record_l7[,2],m_record_l8[,2],m_record_l9[,2],m_record_l10[,2],m_record_l11[,2],m_record_l12[,2],m_record_l13[,2],m_record_l14[,2],m_record_l15[,2],m_record_l16[,2],m_record_l17[,2],m_record_l18[,2])
  m_record_a3<-cbind(m_record_l3[,3],m_record_l4[,3],m_record_l5[,3],m_record_l6[,3],m_record_l7[,3],m_record_l8[,3],m_record_l9[,3],m_record_l10[,3],m_record_l11[,3],m_record_l12[,3],m_record_l13[,3],m_record_l14[,3],m_record_l15[,3],m_record_l16[,3],m_record_l17[,3],m_record_l18[,3])
  m_record_a4<-cbind(m_record_l3[,4],m_record_l4[,4],m_record_l5[,4],m_record_l6[,4],m_record_l7[,4],m_record_l8[,4],m_record_l9[,4],m_record_l10[,4],m_record_l11[,4],m_record_l12[,4],m_record_l13[,4],m_record_l14[,4],m_record_l15[,4],m_record_l16[,4],m_record_l17[,4],m_record_l18[,4])
  m_record_a5<-cbind(m_record_l3[,5],m_record_l4[,5],m_record_l5[,5],m_record_l6[,5],m_record_l7[,5],m_record_l8[,5],m_record_l9[,5],m_record_l10[,5],m_record_l11[,5],m_record_l12[,5],m_record_l13[,5],m_record_l14[,5],m_record_l15[,5],m_record_l16[,5],m_record_l17[,5],m_record_l18[,5])
  m_record_a6<-cbind(m_record_l3[,6],m_record_l4[,6],m_record_l5[,6],m_record_l6[,6],m_record_l7[,6],m_record_l8[,6],m_record_l9[,6],m_record_l10[,6],m_record_l11[,6],m_record_l12[,6],m_record_l13[,6],m_record_l14[,6],m_record_l15[,6],m_record_l16[,6],m_record_l17[,6],m_record_l18[,6])
  m_record_b1<-cbind(m_record_l3[,7],m_record_l4[,7],m_record_l5[,7],m_record_l6[,7],m_record_l7[,7],m_record_l8[,7],m_record_l9[,7],m_record_l10[,7],m_record_l11[,7],m_record_l12[,7],m_record_l13[,7],m_record_l14[,7],m_record_l15[,7],m_record_l16[,7],m_record_l17[,7],m_record_l18[,7])
