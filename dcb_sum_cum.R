dcb_sum_cum<-function(data_org,n_ch) {
  ...
  if (threads <= 8) {
    ...
    bst.a6<-xgboost(data = trains.T.a6,label = res_m[,6],nrounds = 300,verbose=0,params = list(tree_method = 'hist'))
    bst.b1<-xgboost(data = trains.T.b1,label = res_m[,7],nrounds = 300,verbose=0,params = list(tree_method = 'hist'))
    ...
    bst.a6<-xgboost(data = trains.T.a6,label = res_m[,6],nrounds = 300,verbose=0,params = list(tree_method = 'hist',nthread=number_of_core))
    bst.b1<-xgboost(data = trains.T.b1,label = res_m[,7],nrounds = 300,verbose=0,params = list(tree_method = 'hist',nthread=number_of_core))
